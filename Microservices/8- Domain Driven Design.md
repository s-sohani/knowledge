...
مثلا یک کلاس person داریم. به جای اینکه آخرین اطلاعات نام و نام خانوادگی person رو ذخیره کنیم میایم event هاش رو ذخیره میکنیم. مثلا یک Event داریم برای ساخت شی person یک event داریم برای بروز کردن نام و یک event داریم برای بروز کردن نام خانوادگی. برای ذخیره کردن که رخداد ها رو ذخیره میکنیم. مثلا طرف اومده شی رو ساخته، پس رخداد ساخت شی همراه با نام و نام خانوادگی رو ذخیره میکنی. بعد مدتی اومده اسمش رو تغییر داده پس میایم رخداد تغییر نام رو براش ذخیره میکنیم
برای load کردن هم لیست همه Event ها روی این شی رو میگیریم و به ترتیب اعمالش میکنیم یعنی از رخداد ساخت شی با نام و نام خانوادگی رو اعمال میکنیم و بعد میایم رخداد تغییر نام رو براش اعمال میکنیم اینطوری شی را با بروز ترین State ساختیم. 