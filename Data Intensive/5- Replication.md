...
اگر کاربر دیتای خودش رو همزمان از روی چندتا دیوایس بخواد ببینه که دیگه هیچی!! مشکل بزرگتر میشه : cross-device read-after-write consistency
...
# Monotonic Reads
فقط که مشکل اوناج نیست که کاربر میخواد دیتایی که خودش نوشته رو بلافاصله بخونه. فرض کنید کاربر اول یه دیتایی رو نوشته. کاربر دوم میخاود اونو بخونه. اگر یکبار درخواست کنه و دیتای به روز دریافت نکنه طوری نیست. اگر درخواست خواندنش رو چندبار تکرار کنه و هربار جواب متفاوت از فالوور متفاوت بگیرم. اول تغییرات جدید دیتا رو ببینه. رفرش کنه بعدش تغییرات رو دیگه نبینه. دوباره رفرش کنه تغییرات رو ببینه :D 
...
یه چی که خیلی متوجه نشدم این بود که گفت این آنومالی بیشتر تو دیتابیس های پارتیشن بندی شده دیده میشه. چرا؟ آیا تاخیر نتوورک میتونه دلیلش باشه؟؟
...
در مدل چند لیدری اگر یک دیتاسنتر دچار مشکل بشه، دیگه هزینه هایی که در مدل تک لیدری میدادیم رو نمیدیم.
...
با این راه حل یکی از مزیت های محل مدل چند لیدری رو از دست میدیم اونم بهبود پرفورمنس عملیات نوشتن هست.
